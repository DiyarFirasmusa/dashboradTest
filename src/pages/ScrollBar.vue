...
async function fetchItems() {
  try {
    const response = await axios.get('http://ao8kgskw4wcs0ck48sgwg440.194.163.168.91.sslip.io/api/Sponser', {
      headers: {
...
async function saveItem() {
  ...
  if (valid.value) {
    try {
      ...
      `http://ao8kgskw4wcs0ck48sgwg440.194.163.168.91.sslip.io/api/Sponser/${newItem.value.id}`,
      ...
      ` http://ao8kgskw4wcs0ck48sgwg440.194.163.168.91.sslip.io/api/Sponser`,
          null, // No body is sent
          {
            params: { url: newItem.value.url }, // Pass the `url` parameter in the query string
            headers: {
...
async function confirmDeleteItem() {
  try {
    const response = await axios.delete(`http://ao8kgskw4wcs0ck48sgwg440.194.163.168.91.sslip.io/api/Sponser/${itemToDelete.value.id}`, {
      headers: {
        Authorization: `Bearer ${token}`
      }
    });
